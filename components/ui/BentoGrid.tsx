...
export const BentoGridItem = ({
  ...
  const handleCopy = () => {
    navigator.clipboard.writeText("vidh40@gmail.com");
    setCopied(true);
    console.log("clicked");
  };
  return (
    <div
      className={cn(
        "row-span-1 rounded-3xl overflow-hidden relative group/bento hover:shadow-xl transition duration-200 shadow-input dark:shadow-none border border-white-100/[0.1] justify-between flex flex-col space-y-4",
        className
      )}
      style={{
          ...
          {id === 3 && (
            <div className="flex gap-1 lg:gap-5 w-fit absolute -right-3 lg:-right-2">
              <div className="flex flex-col gap-3 md:gap-3 lg:gap-8">
                {["Next.js", "React", "TypeScript"].map((item) => (
                  <span
                    key={item}
          ...
          {id === 6 && (
            <div className="mt-5 relative">
              ...
              <ShimmerButton
                ...
                icon={<IoCopyOutline />}
                position="left"
                otherClasses="!bg-[#161A31] flex gap-2"
